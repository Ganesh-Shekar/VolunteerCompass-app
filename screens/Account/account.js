...
import { UserCircleIcon, ArrowRightOnRectangleIcon, ChevronRightIcon } from 'react-native-heroicons/outline';
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity style={[styles.aboutPage, {borderTopWidth:StyleSheet.hairlineWidth}]}>
        ...
        <TouchableOpacity style={{flexDirection: 'row', alignItems:'center',bottom:0, marginBottom:'10%', paddingTop:'4%'}} onPress ={() => logOut()}>
